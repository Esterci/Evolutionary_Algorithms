...
Planned: 2 independent runs per mode; 200 DE generations, at most 15568 Adam updates.

Maximum total loss evaluations per run: 22000. Actual costs are listed below.

| Mode | Completed / planned | Test RMSE (mean ± sample SD) | Training time (s) |
| --- | --- | --- | --- |
| de | 2 / 2 | 0.246777 ± 0.0157117 | 940.2 |
| pinn | 2 / 2 | 0.245421 ± 0.000650777 | 885.5 |
| both | 2 / 2 | 0.301046 ± 0.0736239 | 578.7 |
| none | 2 / 2 | 0.245359 ± 0.00421574 | 901.3 |
