...
Run from the work_4 root (Bash and Python 3 are required):

```bash
bash shells/clean_results.sh fvm --dry-run
bash shells/clean_results.sh fvm
bash shells/clean_results.sh pinn
bash shells/clean_results.sh pinn-de
```
