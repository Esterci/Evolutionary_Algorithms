...
lowest-cost feasible pressure-vessel execution and saves:
...
The horizontal axis focuses on the first 500 evaluations, where the largest
fitness and violation changes occur. The figures do not compare algorithms or
models.
